...
public class StatisticController {
   ...
   @ResponseBody
    public String healthstatistic(@RequestParam Map<String, String> map) {
    ...
    @ResponseBody
    public String dailystatistic(@RequestParam Map<String, String> map) {
    ...
    @RequestMapping(value = "/academyhealthstatistic", method = RequestMethod.POST)
    @ResponseBody
    public String academyhealthstatistic(HttpServletRequest request, @RequestBody String id,
    ...
    @RequestMapping(value = "/academydailystatistic", method = RequestMethod.POST)
    @ResponseBody
    public String academydailystatistic(HttpServletRequest request, @RequestBody String id,
                                         @RequestParam Map<String, String> map) {
            String username = id.substring(0, id.length() - 1);
            String academy = teacherService.findTeacherById(username).getAcademy();
